...
export const StudentIntakeFormFields = ({
  ...
  return (
    <>
      ...
      <label><span>Middle name</span><input maxLength={100} autoComplete="additional-name" {...field('middleName')}/></label>
      ...
      <label><span>Contact phone</span><input minLength={7} maxLength={64} autoComplete="tel" {...field('contactPhone')}/></label>
