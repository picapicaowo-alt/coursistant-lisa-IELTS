...
describe('ParentApiService', () => {
  ...
  it('uses the linked-student academic read routes', async () => {
    ...
    await service.listStudentCalendar(41, {from: '2026-09-01', to: '2026-09-15', timezone: 'America/Los_Angeles'});
    ...
    expect(client.get).toHaveBeenNthCalledWith(3, '/v2/parent/students/41/calendar', {params: {from: '2026-09-01', to: '2026-09-15', timezone: 'America/Los_Angeles'}});
  });
